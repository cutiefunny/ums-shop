...
// AuthHeader는 상위 Wrapper 컴포넌트에서 렌더링되므로 여기서는 제거합니다.
...
export default function NotificationsClientPage() { // 컴포넌트 이름을 NotificationsClientPage로 변경
  ...
  // 초기값은 'settings'로 설정하고, useEffect에서 URL 파라미터를 읽습니다.
  ...
  // handleBack은 이제 상위 Wrapper에서 처리합니다.
  // const handleBack = () => {
  //   router.back();
  // };
  ...
  return (
    <> {/* Fragment를 사용하여 Header는 상위 컴포넌트에서 렌더링되도록 합니다. */}
      {/* Notifications 탭 컨트롤 */}
